...
public class PersonaController {
    ...
    // =========================
    @GetMapping("/me")
    @PreAuthorize("hasRole('CLIENTE') or hasRole('MESERO') or hasRole('ADMINISTRADOR') or hasRole('COCINERO') or hasRole('BODEGUERO')")
    ...
    // =========================
    @PutMapping("/{id}")
    @PreAuthorize("hasRole('ADMINISTRADOR') or hasRole('MESERO') or hasRole('CLIENTE') or hasRole('COCINERO') or hasRole('BODEGUERO')")
